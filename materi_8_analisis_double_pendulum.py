# -*- coding: utf-8 -*-
"""Materi-8 Analisis Double Pendulum.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1x93AgN9VpEhWlePbSEc6GL0CdIT50yI9
"""
...
# Menambahakan salah satu contoh fungsi numerik untuk mendapatkan nilai
...
def animate(i):
    ...
    ln3.set_data(x1[::10][i:max(1,i-trail2):-1], y1[::10][i:max(1,i-trail2):-1])  # Jejak dan garis pada benda 2

fig, ax = plt.subplots(1,1, figsize=(8,8))
ax.set_facecolor('k')
ax.get_xaxis().set_ticks([])    # Menyembunyikan garis sumbu x
ax.get_yaxis().set_ticks([])    # Menyembunyikan garis sumbu y
ln1, = plt.plot([], [], 'ro-', lw=3, markersize=g)
ln2, = plt.plot([], [], 'ro-',markersize= 8, alpha=0.05, color='cyan')  # line for Earth
ln3, = plt.plot([], [], 'ro-',markersize= 8,alpha=0.05, color='cyan')
ax.set_xlim(-44, 44)
ax.set_ylim(-44, 44)

# Animasi gerak double pendulum
ani = animation.FuncAnimation(fig, animate, frames=2000, interval=50)
#ani.save('pen.giv',writer='pillow',fps=50)
